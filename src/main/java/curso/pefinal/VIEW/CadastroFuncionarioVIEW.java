...
public class CadastroFuncionarioVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        funcaoTxt = new javax.swing.JComboBox<>();
        ...
        senhaLabel1.setForeground(new java.awt.Color(255, 255, 255));
        senhaLabel1.setText("FUNÇÃO:");

        funcaoTxt.setBackground(new java.awt.Color(51, 51, 51));
        funcaoTxt.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        funcaoTxt.setForeground(new java.awt.Color(255, 255, 255));
        funcaoTxt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...", "BODYPIERCER", "TATUADOR", "SECRETÁRIA" }));
        funcaoTxt.setBorder(null);
                                            ...
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                        ...
                                                        .addComponent(datanascTxt, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE))
                                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void cadastrarFuncionario(int opcao){
        ...
        if(limitaCaractere() == true) try {
            ...
            if(rsTesteDAO.next()){
                ...
                try{
                    ...
                    funcao = funcaoTxt.getSelectedIndex();
                    ...
                    if(opcao == 1){
                        ...
                        funcionario.setId_funcionario(cod);
                    }
                    //enviando para o bd
                    FuncionarioDAO objFuncionarioDAO = new FuncionarioDAO();
                    
                    if(opcao == 0){
                        objFuncionarioDAO.cadastrarFuncionario(funcionario);
                        JOptionPane.showMessageDialog(null, "Cadastrado com Sucesso!!");
                    }else{
                        objFuncionarioDAO.alterarFuncionario(funcionario);
                        JOptionPane.showMessageDialog(null, "Alterado com Sucesso!!");
                    }
                    
                    dispose();
                }catch(Exception erro){
                    JOptionPane.showMessageDialog(null,"CadastroFuncionarioVIEW: " + erro);
                }
            }
    ...
    public void alterarFuncionarios(int id){
        ...
        try{
            ...
            funcionarioDTO = funcionario.funcionarioAlteracao(id);
            ...
            codTxt.setText(Integer.toString(funcionarioDTO.getId_funcionario()));
            nomeTxt.setText(funcionarioDTO.getNome());
            CPFTxt.setText(funcionarioDTO.getCpf());
            datanascTxt.setText(funcionarioDTO.getData_nasc());
            telefoneTxt.setText(funcionarioDTO.getTelefone());
            ...
            funcaoTxt.setSelectedIndex(funcionarioDTO.getFuncao());
            ...
            JOptionPane.showMessageDialog(null, "Alterar CadastroFuncionarioVIEW: " + erro);
        }
    ...
    private javax.swing.JComboBox<String> funcaoTxt;
